...
Le **Mode test** permet de préparer les scènes OBS sans ouvrir Deezer. Il peut envoyer à l’overlay un titre très long, une pochette absente, une lecture ou une pause, plusieurs changements de titre et un signal synthétique aux basses faibles ou fortes. Le titre, l’artiste, l’album, la source, la pochette et l’intensité des basses peuvent aussi être saisis manuellement. La simulation remplace temporairement la session Deezer, ne déclenche pas les webhooks SAMMI et rend automatiquement la main aux données réelles lorsqu’elle est arrêtée.
