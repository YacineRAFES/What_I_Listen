...
Dans OBS, le visualiseur réagit en temps réel au son qui sort de Windows. Dans **Paramètres**, choisis la sortie audio exacte à analyser, par exemple `SteelSeries Sonar - Media` pour Deezer ; aucune installation de câble audio virtuel n’est nécessaire. Tu peux aussi choisir le style de l’overlay : **Luna** affiche des barres, **Winamp Classic** son spectrum segmenté, **Glass** des ondes, **Aura** un halo et **Néon rétro** une grille synthwave et des barres lumineuses. Le choix est mémorisé et s’applique immédiatement dans l’aperçu et dans OBS.
