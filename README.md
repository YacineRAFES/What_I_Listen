...
Dans OBS, le visualiseur réagit en temps réel au son qui sort de Windows. Dans **Paramètres**, choisis la sortie audio exacte à analyser, par exemple `SteelSeries Sonar - Media` pour Deezer ; aucune installation de câble audio virtuel n’est nécessaire. Le menu **Styles** permet de choisir l’habillage de l’overlay : **Luna** affiche des barres, **Winamp Classic** son spectrum segmenté, **Glass** des ondes, **Aura** un halo, **Néon rétro** une grille synthwave et des barres lumineuses, **Spectrum** un spectrum pleine largeur de 32 bandes en miroir, **Battery** des halos et ondes abstraites, **VU Meter LED** des colonnes segmentées vertes, jaunes et rouges avec leurs crêtes, et **Oscilloscope** une trace CRT lumineuse inspirée des 16 bandes. Trois rendus WebGL/GLSL enrichissent la bibliothèque : **Tunnel hyperspace** accélère ses anneaux 3D avec les basses, **Particules cosmiques** anime un champ coloré par fréquence et **Kaléidoscope** dessine des rubans psychédéliques symétriques. Si WebGL2 est indisponible ou interrompu, ils basculent automatiquement sur leur rendu Canvas 2D. Spectrum propose les palettes **Moderne**, **Ocean Mist**, **Fire Storm** et **Scope**. Le choix est mémorisé et s’applique immédiatement dans l’aperçu et dans OBS.
