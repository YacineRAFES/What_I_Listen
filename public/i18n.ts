(() => {
  const messages: Readonly<Record<'fr' | 'en', Readonly<Record<string, string>>>> = Object.freeze({
    fr: {
      ...
      'app.preview.open': 'Ouvrir l’aperçu',
      'app.preview.unavailable': 'L’aperçu est disponible dans l’application What I Listen.',
      'app.preview.opened': 'Aperçu ouvert. Il reflète le thème sélectionné.',
      'app.preview.error': 'Impossible d’ouvrir l’aperçu. Réessaie.',
    ...
    en: {
      ...
      'app.preview.open': 'Open preview',
      'app.preview.unavailable': 'The preview is available in the What I Listen application.',
      'app.preview.opened': 'Preview opened. It reflects the selected theme.',
      'app.preview.error': 'Could not open the preview. Please try again.',
